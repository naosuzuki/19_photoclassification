...
\hline
Index &    ID &  Flag &        z &  z\_stat &  dof & label1 & label2 &\multicolumn{5}{|p{14.5em}}{Input:\ absolute mag.+norm. flux} & \multicolumn{5}{|p{10.5em}}{Input:\ mag.+norm. flux}\\
\hline
      &       &       &          &          &      &        &        & 2-class &\multicolumn{4}{p{10.0em}|}{3-class}&2-class &    \multicolumn{4}{p{10.0em}}{3-class}\\
\hline
...
Incomplete events account for only 27\% of the total classified supernovae, and it is difficult to classify them even with conventional template fitting.
%In the confusion matrix for all labeled supernovae in Figure \ref{fig:h2_test_CM}, 63\% of the 190 supernovae labeled nonIa and classified by machine as Ia (i.e. false positive) are "incomplete events" that do not include a peak phase during the entire observation period.
...
supernovae \citep{tsujimoto95a,kobayashi00a}.  
Recent studies show that the solar abundance pattern is observed in clusters and 

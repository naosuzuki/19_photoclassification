...
For three class classification, we set the ratio of Ibc:II=3:7 among Non-SN~Ia.
The redshfit distribution of galaxies is taken from COSMOS survey (cite).
Throughout this paper, we use $\Lambda$CDM cosmology with $\Omega_{m}$=0.3 and h=0.7.
Then, we use Subaru/HSC filter responses including system throughput from \citet{kawanomoto18a}.

...
We use Subaru/HSC filter responses including system throughput from \citet{kawanomoto18a}, and
LSST blue book (cite) for LSST photometric data points we describe in the following subsection.

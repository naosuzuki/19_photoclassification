...
We are conducting transient survey with Hyper Suprime-Cam on Subaru Telescope which enables us to probe wide filed (1.77 deg$^2$ Fielf of View) and deep space (26th mag in $i-$band / epoch).  Our primary scientific goals are Type Ia Supernova (SNIa) cosmology, Type II Supernova Cosmology, Super Luminous Supernova (SLSN) studies.   As is reported in Yasuda et al. (2019), more than 1000 SNe are discovered in a 6-month campaign. 
...
\end{itemize}
\subsection{Classification methods for HSC survey : Takahashi}
%
...
{\bf Highway layer:}
We adopted Highway Layer \citep{srivastava15a} and the number of layers is optimized through hyper-parameter search.   In theory, we can design a very deep layer and the number of layers can be more than we need.   In fact, it is not trivial to find the optimized number of layers.   
...
We adopt Batch Normalization (\cite{batch_norm}) to accelerate and stabilize the optimization.  Even if it may be a large number of parameters we need to train, Bach Normalization helps converge the training, reduce errors on the slope when we apply entropy minimization, prevents the average and dispersion goes exponentially large in deep layers, and minimize the biases on outputs \citep{understanding_batch_norm}.
...
For the first iteration, we do not know what kind of transformation is the best, the transformation itself is taken as one of the hyperparameters and optimized later.   The details of this step is discussed later, but functions in 'tf.nn' is being used.
...
\begin{table*}[t]
  \tbl{The optimized hyper-parameters for the classification(C=2)}{
      \begin{tabular}{lllllll}
\hline
      &                                       & the number of blocks T & hidden size D & drop rate & bn & type    \\ \hline
flag0 & absolute magnitude \& normalized flux & 5                      & 178           & 9.47e-3   & 1  & sigmoid \\
      & magnitude \& normalized flux          & 4                      & 531           & 6.43e-3   & 0  & linear  \\
      & absolute magnitude                    & 3                      & 247           & 9.68e-4   & 1  & sigmoid \\
      & magnitude                             & 4                      & 411           & 9.00e-2   & 1  & sigmoid \\ \hline
flag1 & absolute magnitude \& normalized flux & 5                      & 734           & 8.75e-4   & 0  & tanh    \\
      & magnitude \& normalized flux          & 2                      & 647           & 7.92e-4   & 0  & tanh    \\
      & absolute magnitude                    & 2                      & 389           & 7.17e-2   & 1  & sigmoid \\
      & magnitude                             & 2                      & 342           & 1.42e-2   & 1  & sigmoid \\ \hline
flag2 & absolute magnitude \& normalized flux & 2                      & 368           & 1.79e-3   & 1  & sigmoid \\
      & magnitude \& normalized flux          & 5                      & 572           & 4.27e-3   & 1  & sigmoid \\
      & absolute magnitude                    & 4                      & 920           & 1.44e-3   & 0  & sigmoid \\
      & magnitude                             & 4                      & 640           & 1.12e-1   & 1  & sigmoid \\ \hline
flag3 & absolute magnitude \& normalized flux & 5                      & 893           & 1.42e-3   & 1  & sigmoid \\
      & magnitude \& normalized flux          & 3                      & 300           & 5.00e-3   & 1  & linear  \\
      & absolute magnitude                    & 4                      & 880           & 1.98e-2   & 1  & sigmoid \\
      & magnitude                             & 3                      & 930           & 9.77e-2   & 1  & sigmoid \\ \hline
flag4 & absolute magnitude \& normalized flux & 5                      & 379           & 4.21e-3   & 1  & sigmoid \\
      & magnitude \& normalized flux          & 5                      & 140           & 4.04e-3   & 1  & sigmoid \\
      & absolute magnitude                    & 2                      & 631           & 1.77e-2   & 0  & sigmoid \\
      & magnitude                             & 4                      & 567           & 5.77e-2   & 0  & sigmoid \\ \hline
\end{tabular}
  }\label{tb:searched_hp_class}
\end{table*}

\begin{table*}[t]
  \tbl{The optimized hyper-parameters for the classification(C=3)}{
      \begin{tabular}{lllllll}
\hline
      &                                       & the number of blocks T & hidden size D & drop rate & bn & type    \\ \hline
flag0 & absolute magnitude \& normalized flux & 4                      & 429           & 1.20e-3   & 0  & linear  \\
      & magnitude \& normalized flux          & 4                      & 608           & 1.72e-2   & 0  & linear  \\
      & absolute magnitude                    & 4                      & 516           & 2.54e-3   & 0  & tanh    \\
      & magnitude                             & 4                      & 838           & 1.36e-3   & 0  & tanh    \\ \hline
flag1 & absolute magnitude \& normalized flux & 4                      & 915           & 1.03e-2   & 0  & linear  \\
      & magnitude \& normalized flux          & 4                      & 540           & 1.45e-3   & 0  & linear  \\
      & absolute magnitude                    & 5                      & 698           & 2.79e-2   & 0  & linear  \\
      & magnitude                             & 2                      & 520           & 9.99e-4   & 1  & sigmoid \\ \hline
flag2 & absolute magnitude \& normalized flux & 4                      & 698           & 9.08e-4   & 0  & linear  \\
      & magnitude \& normalized flux          & 4                      & 896           & 8.58e-3   & 0  & linear  \\
      & absolute magnitude                    & 4                      & 614           & 7.03e-3   & 0  & linear  \\
      & magnitude                             & 5                      & 300           & 5.00e-1   & 1  & sigmoid \\ \hline
flag3 & absolute magnitude \& normalized flux & 4                      & 522           & 5.02e-4   & 0  & tanh    \\
      & magnitude \& normalized flux          & 3                      & 462           & 9.28e-4   & 1  & sigmoid \\
      & absolute magnitude                    & 5                      & 841           & 4.96e-2   & 1  & sigmoid \\
      & magnitude                             & 3                      & 300           & 5.00e-3   & 1  & sigmoid \\ \hline
flag4 & absolute magnitude \& normalized flux & 3                      & 484           & 2.13e-3   & 0  & linear  \\
      & magnitude \& normalized flux          & 5                      & 389           & 1.23e-4   & 0  & tanh    \\
      & absolute magnitude                    & 4                      & 243           & 3.21e-3   & 1  & sigmoid \\
      & magnitude                             & 3                      & 354           & 2.14e-1   & 1  & sigmoid \\ \hline
\end{tabular}
  }\label{tb:searched_hp_class}
\end{table*}
...
We defined a highway block and adjusted the size of the network by changing the number of highway blocks.
% highway blockは図2のようにhighway layerを含む最大で三つの層からなる。
The highway block is composed of a maximum of three layers including a highway layer as shown in fig. \ref{fig:dnn_model}.
% ただし、highway layer以外の層については後述するハイパーパラメータ探索により決定した。
However, layers other than Highway layer were determined by a hyperparameter search described later.
...
About 2300 events extracted from PLAsTiCC data were used for the test set.
...
The numbers of supernovae classified as Ia by the classifier are 612, 436, and 186 out of 1540 when the threshold value of Ia probability are 0.5, 0.7, and 0.9, respectively.
%
...
Our classifier predicts 1812 supernova classes with a ratio of Ia : Ibc : II = 0.41 : 0.07 : 0.52.
...
\begin{figure}[ht]
  \begin{center}
     \includegraphics[width=\columnwidth]{figures/14_piechart_abs-mag_scaled-flux_w-mixup_remove-y_predictions_test_Flagall.eps}
  \end{center}
  \caption{%
  Ratio of predictions in the three-class classificateion of test dataset.
  }%
...
The best classifier in the PLAsTiCC competition is based on Light-GBM and trained with features extracted from photometric data modeled by Gaussian process regression \citep{2019arXiv190704690B}.
...
While our classifier and PLATiTiCC 1st classifier cannot be strictly compared because of the different training data sets,
Our classifier is about 6\% better in total accuracy than the PLAsTiCC 1st classifier and 6\% better in Ia accuracy.
...
\begin{itemize}
\item 45\% (46/107) of them are edge events, while they are only 22\% of all events.
...
In the three-class classification of the PLAsTiCC data set, we found that the accuracy of Ibc was lower than that of other classes, and that the accuracy dropped significantly in the vicinity of redshift1.0, and in addition, the accuracy also decreased in the nearby Ibc.
...
If we input two weeks of supernova data, we can classify it with about 90\% accuracy.

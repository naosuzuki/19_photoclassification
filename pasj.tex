...
the supernova, but it monotonically drops and the event happens at the core of the galaxy.
...
\citet{Lochner_2016} obtained an AUC of 0.984 by classification with boosted decision trees (BDTs) using the SALT2 fitting parameter as a feature.

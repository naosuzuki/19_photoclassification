...
\end{equation}
where $f_i$^{\mathrm{scale}} is $i$-th raw observed flux normalized by its maximum flux:
\begin{equation}
...
For simplicity, we ignore K-correction and use distance modulus based on $\Lambda$CDM with photometric redshift

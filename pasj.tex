...
For normal SN~Ia, we use SALT2 \citep{guy10a} model ({\it ver} 2.4) which requires 2 input parameters:
...
Based on our pre-experiment with simulated data set, we found that the machines performs best if we normalize input data as follows:
\begin{equation}
...
\hline
 & $M$ & $m$ & $f$ & Case 0 & Case 1 & Case 2 & Case 3 & Case 4 & All & Case 0 & Case 1 & Case 2 & Case 3 & Case 4 & All \\
\hline
...
of cosmic evolution \citep{fukugiata04}. 
It is now well established that star formation rate is peaking at z$\sim$2, and the chemical composition
of our system is a mixture of SN~Ia and Core Collapse Supernovae \citep{tsujimoto95a,kobayashi00a}.
Deriving supernova rate needs a careful analysis \citep{brown19a,frohmaier19a} and it is beyond the scope 
of this paper, but at least we can check the consistency with previous work on relative fraction.
Lick Observatory Supernova Survey \citep{li11a} reports the ratio between SNIa:Ibc:II to be 24:19:57, 
while we have 24:17:59 at z$\lesssim$0.2. 
...
The trend of SN~II fraction drops towards high redshift and SN~Ia fraction rises is simply because of 
...
z$\sim$0.5. 
The reason why SN~II fraction does not go to zero at z$\sim$1 is that magnitude dispersion is much 
larger in Core-Collapose SN than that of SN~Ia \citep{li11a,kessler19b}, and they are factor of 4-5 
more abundant at z$\sim$1 \citep{strolger15a,hounsell18a}. 

...
\end{eqnarray}
We justify this operation because we treat training set and observed data set in the same way.
It there existed K-correction offset, both data set experiences in the same way.

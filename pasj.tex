...
First, we need a simulated photometric data to train the machine ($\S$X)
Second, we want to have a realistic data set which we know the answer
...
\subsection{Simulatied Data for Training}

...
We conducted a transient survey with Hyper Suprime-Cam (HSC) on Subaru Telescope. 
HSC Transient Survey enables us to probe wide filed (1.77 deg$^2$ Field of View) and deep space (26th mag in $i-$band / epoch).  Our primary scientific goals are Type Ia Supernova (SNIa) cosmology, Type II Supernova Cosmology, Super Luminous Supernova (SLSN) studies as well as probing unknown population of transients.  
As is reported in \citet{yasuda19a}, more than 1800 SNe are discovered in a 6-month campaign. 
We deployed AUC boosting for transient detection \citep{morii16a}, we have already adopted AUC boosting method for transient detection, namely 'real' vs. 'bogus'.

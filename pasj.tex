...
of Subaru HSC.   Rapid transients are discovered, but their identities are yet to be known (Tampo et al.  2020 in prep).
Similar objects are also reported by DES team (cite).
...
We chose three classes for simplicity and in fact, the majority of supernovae goes to one of these three categories.
%

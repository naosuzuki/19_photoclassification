...
Subaru Hyper-Suprime Cam transient survey is a part of Subaru Strategic Project (SSP) which is a five-year
program with 300 dark nights. (cite aihara, miyazaki)
HSC transient survey is executed for consective 6 monghth from November 2016 through April 2017.
HSC is mounted on the prime focus for 2 weeks in dark time.   
Weather permitted, 2 data points per filter are scheduled to observe. 
%\begin{itemize}

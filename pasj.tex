...
Type II supernova cosmology program needs a timely spectroscopic follow-up to measure the expansion velocity of photosphere \citep{dejaeger17a}.
Superluminous Supernova (SLSN) is of great interest today, it is relatively a rare event\citep{quimby11a,galyam12a} and its mechanism is just began to be understood \citep{moriya10a}, and it can probe high redshift universe \citep{moriya19a}.    
For SLSN project, timely spectroscopic follow-up is also critical \citep{curtin19a}.
...
%Early phase Core Collapse Supernova is also interesting to study for 

...
Convolution Neural Network (CNN) has been used for photometric redshift studies from the early stage.  Today, many Machine Learning methods are applied to photometric redshift studies (cite).
Deep Neural Network (DNN) is now being used for astronomical imaging data for galaxy morphology classifications (cite).
...
program with 300 dark nights. (cite aihara, miyazaki)
...
Survey strategies and observing logs are reported in \citet{yasuda19a}, and we use the observed phtometric data described in \citep{yasuda19a}.

One of our primary goals of HSC Transient survey is Type Ia Supernova Cosmology whcih aims to perform the most precise measurement of dark energy at high-redshift and test if dark energy is changing in time.
We are awarded 96 orbits of the Hubble Space Telescope time to execute a follow up on precise 

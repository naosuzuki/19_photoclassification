...
As described in \citet{yasuda19a}, this survey is part of HSC SSP survey, where observations were performed in two areas with different observation frequencies, "Deep" area and "Ultra-Deep" area.
...
As described in section 4.2.2, for supernovaes without redshift information, we can also estimate their redshift using a model that has largely the same structure as the type classifier.
The training and input data are common to the type classification.
In this section, we discuss the accuracy of the redshift estimation.

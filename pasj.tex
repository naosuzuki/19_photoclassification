...
Deriving supernova rate needs a careful analysis and it is beyond the scope of this paper, but at least
we can check the consistency with previous work on relative fraction.
Lick Observatory Supernova Survey \citep{li11a} reports the ratio between SNIa:Ibc:II to be 24:19:57, 
while we have 25:18:58 (TBC) at z$\sim$0.1. 
Based on the median depth, our survey have a complete sampling of SN~Ia up to z$\sim$1.1 while we lose
completenss of core collapse supernova in lower redshift.
